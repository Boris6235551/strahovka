...
?>
        <div class='wrapper'>
            <div class='sidebar'>
                <div class='sidebar_block'>
                    ...
                    <ul class='sidebar_nav blue'>
                        ...
                        <li>
                            <a class='active' href='/fiz/auto/osgo'>ОСГО</a>
                        </li>
                        <li>
            ...
            <div class='content'>
                ...
                <form accept-charset="UTF-8" action="<?php echo get_permalink(115);?>" class="calc order telefon" method="post">
                    <div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /></div>
                    <div class='form_row'>
                        <h3>Оформить заказ на &laquo;ОСГО&raquo;</h3>
                        <div class='request-description'>
                            <p>После заполнения заявки на обязательное страхование автомобиля - наши специалисты свяжутся с вами для скорейшего решения вопроса.</p>
                            <p>&nbsp;</p>
                            <p><strong>ВАЖНО</strong>: К сожалению, на сегодняшний день мы <strong>не</strong> осуществляем доставку полисов по обязательному страхованию гражданской ответственности (ОСГО).</p>
                        </div>
                    </div>
                    <div class='form_row'>
                        <label>Имя:</label>
