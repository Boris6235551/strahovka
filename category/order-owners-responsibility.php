<?php
/*
Template Name: order-owners-responsibility
*/
...
?>
        <div class='wrapper'>
            <div class='sidebar'>
                ...
                <div class='sidebar_block'>
                    ...
                    <ul class='sidebar_nav orange'>
                        ...
                        <li>
                            <a class='active' href='/fiz/house/owners-responsibility'>Ответственность владельцев квартир</a>
                        </li>
                    </ul>
                </div>
                <div class='sidebar_block'>
            ...
            <div class='content'>
                ...
                <form accept-charset="UTF-8" action="<?php echo get_permalink(135);?>" class="calc order telefon" method="post">
                    <div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /></div>
                    <div class='form_row'>
                        <h3>Оформить заказ на &laquo;Ответственность владельцев квартир&raquo;</h3>
                    ...
                    <div class="form_row"><label>Тип строения:</label><select name="house_kind" class="country_select">
                            <option>Дом</option>
                            <option>Квартира</option>
                        </select></div>
                    <div class="form_row"><label>Оценочная стоимость строения с отделкой:</label><input name="estimated_price" type="text" class="input_name" value="" /></div>
                    <div class="form_row"><label>Стоимость имущества внутри:</label><input name="assets_price" type="text" class="input_name" value="" /></div>
