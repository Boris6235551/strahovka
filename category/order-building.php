...
?>
        <div class='wrapper'>
            <div class='sidebar'>
                ...
                <div class='sidebar_block'>
                    ...
                    <ul class='sidebar_nav orange'>
                        <li>
                            <a class='active' href='/fiz/house/house'>Строение</a>
                        </li>
                        <li>
            ...
            <div class='content'>
                ...
                <form accept-charset="UTF-8" action="<?php echo get_permalink(131);?>" class="calc order telefon" method="post">
                    <div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /></div>
                    <div class='form_row'>
                        <h3>Оформить заказ на &laquo;Строение&raquo;</h3>
